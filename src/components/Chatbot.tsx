...
import type { UserProfile, Skill, RoleDefinition, GapAnalysisResult, LearningResource } from '../types';
import { sendChatMessage, type ChatMessage, type UserContext } from '../utils/openai';
import './Chatbot.css';
...
export function Chatbot({
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: 'assistant',
      content: `Hi${userProfile.name ? ` ${userProfile.name}` : ''}! I'm CareerPath AI, your personal career guidance assistant. I can help you with:
